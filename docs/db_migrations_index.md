...
- wqt-backend/migrations/20251227_add_missing_onboarding_and_scheduled_start.sql
  - Adds `users.default_shift_hours`, `users.onboarding_version` (DEFAULT 0), `users.onboarding_completed_at`, plus `shift_sessions.scheduled_start_at` (all IF NOT EXISTS).
